...
static PyMethodDef bruce_c_methods[] = {
    ...
    {"check_proximity_of_timestamps", check_proximity_of_timestamps, METH_VARARGS, "Keep trial epochs with any observation within +/- 0.5*width (the template's contribution window)."},
